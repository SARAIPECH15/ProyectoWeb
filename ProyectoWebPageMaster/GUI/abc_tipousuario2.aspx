<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/administrador.Master" AutoEventWireup="true" CodeBehind="abc_tipousuario2.aspx.cs" Inherits="ProyectoWebPageMaster.GUI.abc_tipousuario2"  EnableEventValidation="false"%>
...
<section class="resume-section align-items-center" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Ingrese los datos aquí:</p>
	  ...
	  <asp:TextBox ID="Txt_tipou" runat="server" CssClass="form-control" OnTextChanged="Txt_tipou_TextChanged" ></asp:TextBox>
	  <br />
